...
Shared agent guide for `@arkade-os/sdk` — TypeScript SDK for building
Bitcoin wallets on the Arkade protocol. This file is the single source
of truth for AI agents (Claude, Codex, Gemini, …) working in this
repository; agent-specific entrypoints (`CLAUDE.md`, `AGENTS.md`,
`GEMINI.md`) import this file instead of duplicating project facts.

See [`README.md`](README.md) for the public API and usage; this file
