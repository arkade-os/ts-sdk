...
function App() {
    ...
    const debugWallet = () => {
        ...
        addStatus(
            `Found ${debugInfo.providers.length} wallet providers:`,
            "info"
        );
        ...
        const xverseFound = debugInfo.providers.some(
            (p) => p.name === "Xverse Wallet" || p.id === "BitcoinProvider"
        );
    ...
    return (
        <div className="container">
            <div className="header">
                ...
                <p>
                    Connect your Xverse wallet and create cooperative
                    transactions
                </p>
            </div>
            ...
            <div className="content">
                ...
                {transactionResult && (
                    <div className="section">
                        ...
                        >
                            Your transaction has been submitted to the ARK
                    ...
                    <div className="status-log">
                        {statusMessages.length === 0 ? (
                            <div className="status-message info">
                                ...
                                ARK Wallet Demo - Real Bitcoin transactions via
                                ARK
                            </div>
                        ) : (
