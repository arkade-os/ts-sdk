    ...
    return (
        <div className="app">
                ...
                {role === "assistant" && (
                    <div className="assistant-view">
                        ...
                        <div className="info-box">
                            ...
                            <ol>
                                <li>
                                    <strong>Create a payroll</strong> by adding
                                    recipients manually or importing a CSV file.
                                </li>
                                <li>
                                    <strong>Payroll is submitted</strong> for
                                    admin approval (pending status).
                                </li>
                                <li>
                                    <strong>Admin reviews and executes</strong>{" "}
                                    the payroll by signing with their private
                                    key.
                                </li>
                                <li>
                                    <strong>Recipients receive</strong> BTC on
            ...
            <footer className="app-footer">
                <p>
                    Built with{" "}
                    <a href="https://github.com/arkade-os/ts-sdk">
                        @arkade-os/sdk
                    </a>{" "}
                    and{" "}
                    <a href="https://github.com/lendasat/lendaswap-sdk">
                        Lendaswap SDK
                    </a>
                </p>
            </footer>
