...
describe("Settlement - Auto-settle boarding UTXOs", () => {
    ...
    it("should auto-settle new boarding UTXOs into Ark", { timeout: 120000 }, async () => {
...
describe("Settlement - Auto-sweep expired boarding UTXOs", () => {
    ...
    it("should auto-sweep an expired boarding UTXO via poll loop", {
        timeout: 120000,
    }, async () => {
        const identity = SingleKey.fromRandomBytes();
...
describe("Settlement - VtxoManager Recovery", () => {
    ...
    it("should recover swept VTXOs via recoverVtxos", { timeout: 120000 }, async () => {
        const identity = SingleKey.fromRandomBytes();
...
describe("Settlement - Auto-delegation on vtxo_received", () => {
    ...
    it("should auto-delegate incoming VTXOs when settlement is enabled with delegate", {
        timeout: 120000,
    }, async () => {
        const identity = SingleKey.fromRandomBytes();
...
describe("Settlement - VtxoManager Lifecycle", () => {
    ...
    it("should initialize with settlement enabled and dispose cleanly", {
        timeout: 60000,
    }, async () => {
        const identity = SingleKey.fromRandomBytes();
...
describe("Settlement - VtxoManager concurrent operations", () => {
    ...
    it("should send offchain while VtxoManager background activity is running", {
        timeout: 120000,
    }, async () => {
