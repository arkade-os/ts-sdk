...
`params.emulatorPubkey` (bytes or 33-byte compressed hex) to override it for a self-hosted
emulator, an unpinned network (signet, testnet), or a key rotation the SDK hasn't shipped yet.
