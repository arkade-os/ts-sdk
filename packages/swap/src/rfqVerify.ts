/**
 * Verification helpers and gate functions for RFQ swap corridors.
 *
 * Extracted from rfq.ts — pure verification logic, no transport or comms
 * logic. Error classes and closed sets live in rfqErrors.ts.
 */
import {
 ...
 */
export const assertFinite = (value: number | undefined, reason: string, label: string): void => {
