...
describe("ArkCash", () => {
    ...
    it("should fail to claim already-swept arkcash", async () => {
        ...
        await expect(charlie.wallet.claimCash(cashStr)).rejects.toThrow("No VTXOs found");
    }, 90_000);
    ...
    it("should encode and decode arkcash string correctly", () => {
        ...
        const serverPubKey = pubSchnorr(
            hex.decode("11d2a03264d0efd311d2a03264d0efd311d2a03264d0efd311d2a03264d0efd3"),
        );
