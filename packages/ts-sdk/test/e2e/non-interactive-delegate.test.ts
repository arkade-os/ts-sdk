...
import { addEmulatorPacket, beforeEachFaucet, faucetOffchain } from "./utils";
...
// key), plus an alice-only CSV exit. Mirrors the hand-built VtxoScript. The
// forfeit's arkade self-send covenant (token form of `enforceSelfSend`) requires
...
describe("arkade delegate (covenant batch refresh) — intent submission", () => {
    ...
    it("delegate", { timeout: 180000 }, async () => {
