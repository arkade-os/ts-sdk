...
# can be up at a time.
#
# Usage: scripts/regtest.sh <ts-sdk|swap|swap-rfq> <up|down|reset|setup|test|cycle> [test file...]
...
usage() {
  echo "Usage: $0 <ts-sdk|swap|swap-rfq> <up|down|reset|setup|test|cycle> [test file...]" >&2
  exit 1
}
